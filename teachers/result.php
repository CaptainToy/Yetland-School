...
<html lang="en">
    ...
    <body id="body-pd">
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="./result.html" class="nav__link active">
        ...
        <h2>Add Result</h2>
        <button class="btn"><a href="./addresult.html">Add Result</a></button>
        ...
        <table>
            ...
            <tbody>
                 <tr>
                    ...
                    <td>Basic 1</td>
                    <td><a href="./editResult.html" class="btn sm"><i class='bx bx-pen nav__icon' ></i></a></td>
                    <td><a href="./resultview.html" class="btn sm"><i class='bx bx-low-vision nav__icon' ></i></a></td>
