...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <h2>Student</h2>
        <button class="btn"><a href="./addStudent.html">+ Student</a></button>
        <table>
            <thead>
                <tr>
                    <th>Studentf ID</th>
            ...
            <tbody>
                 <tr>
                    ...
                    <td>Koede</td>
                    <td>Abdulsalam</td>
                    <td><a href="./editStudent.html" class="btn sm"><i class='bx bx-file nav__icon' ></i></a></td>
