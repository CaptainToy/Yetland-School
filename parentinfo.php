...
<body>
  <div class="wrapper">
    <div class="title">Parent Registration Form
    </div>
    <form action="POST" data-netlify="true">
      <div class="form">
        ...
        <div class="inputfield">
          ...
          <input type="text" onkeyup='check()' class="input" id="confirm-password" name=""
            placeholder="Nationality" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
            maxlength="100" minlength="8" required>
        </div>

        <div class="inputfield" id="gender">
            <label for="">Religion</label>
            <input type="radio" name="gender" id="radio" value="Male">Christain
            <input type="radio" name="gender" id="radio" value="Female">Muslim
          </div>
        ...
        <div class="inputfield btns" id="btn">
          <button type="submit" value="Register" class="btn" ><a href="./madicalForm.php">Next</a></button>
        </div>
