...
<body>
    <div class="notice-container">
        ...
        <p class="warning-text">As an HM, you have access to sensitive and critical functionalities. Please ensure to handle your responsibilities with utmost care and diligence. Any misuse of your privileges may result in severe consequences, including but not limited to termination of access and legal action.</p>
        <h2>Agreement</h2>
